...
extern "C" void app_main()
{
    ...
    light_config.color_control_color_temperature.color_temperature_mireds = 313;
    light_config.color_control_color_temperature.color_temp_physical_min_mireds = 111;
    light_config.color_control_color_temperature.color_temp_physical_max_mireds = 667;
